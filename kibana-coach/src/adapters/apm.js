...
globalThis.KibanaApplicationAdapters.push({
  name: 'apm',
  commands: new Set(['select_apm_service', 'select_apm_environment', 'open_transaction_group', 'select_trace_sample', 'select_span', 'open_error_details', 'navigate_to_correlated_logs', 'open_service_map', 'select_service_map_node']),
