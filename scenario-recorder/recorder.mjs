...
async function perform(page, command) {
  ...
  const observations = {
    ...
    select_apm_service:'apm_service_selected', select_apm_environment:'apm_environment_selected', open_transaction_group:'transaction_group_opened', select_trace_sample:'trace_sample_selected', select_span:'span_selected', open_error_details:'error_details_opened', navigate_to_correlated_logs:'correlated_logs_opened', open_service_map:'service_map_opened', select_service_map_node:'service_map_node_selected',
    ...
    open_alert:'alert_opened', filter_alerts:'alerts_filtered', inspect_alert_reason:'alert_reason_inspected', inspect_alert_history:'alert_history_inspected', navigate_from_alert_to_source:'alert_source_opened', open_slo:'slo_opened', inspect_slo_indicator:'slo_indicator_inspected', inspect_slo_error_budget:'slo_error_budget_inspected', inspect_slo_burn_rate:'slo_burn_rate_inspected',
    select_map_region:'map_region_selected', open_synthetics_step:'synthetics_step_opened', open_ml_anomaly:'ml_anomaly_opened'
  };
